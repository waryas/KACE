...
LONG MyExceptionHandler(EXCEPTION_POINTERS* e) {
    ...
    if (e->ExceptionRecord->ExceptionCode == EXCEPTION_PRIV_INSTRUCTION) {
        ...
        case READ_VIOLATION:
            ...
            if (bufferopcode[0] == 0xa1 && bufferopcode[1] == 0x6c && bufferopcode[2] == 0x02 && bufferopcode[3] == 0x00 && bufferopcode[4] == 0x00
                && bufferopcode[5] == 0x80 && bufferopcode[6] == 0xF7 && bufferopcode[7] == 0xff && bufferopcode[8] == 0xff) { //A1 6C 02 00 00 80 F7 FF FF
