...
inline std::unordered_map<std::string, ConstantFunctionPrototype> myConstantProvider = {
    ...
    { "PsGetProcessImageFileName", { 1, h_ObQueryNameString } },//todo impl PsGetProcessImageFileName
    { "PsGetProcessInheritedFromUniqueProcessId", { 1, h_PsGetProcessInheritedFromUniqueProcessId } },
    { "PsAcquireProcessExitSynchronization", { 1, h_ObQueryNameString } }, // todo impl PsAcquireProcessExitSynchronization
    { "PsReleaseProcessExitSynchronization", { 1, h_ObQueryNameString } }, // todo impl PsReleaseProcessExitSynchronization
    { "ExfUnblockPushLock", { 1, h_ObQueryNameString } }, // todo impl ExfUnblockPushLock 
    { "ExEnumHandleTable", { 1, h_ObQueryNameString } }, // todo impl ExEnumHandleTable 
    { "ObOpenObjectByName", { 1, h_ObQueryNameString } }, // todo impl ObOpenObjectByName 
    { "CmUnRegisterCallback", { 1, h_ObQueryNameString } }, // todo impl CmUnRegisterCallback 
    { "MmProbeAndLockPages", { 1, h_ObQueryNameString } }, // todo impl MmProbeAndLockPages 
    { "MmUnlockPages", { 1, h_ObQueryNameString } }, // todo impl MmUnlockPages 
    { "IoAllocateMdl", { 1, h_ObQueryNameString } }, // todo impl IoAllocateMdl 
    { "IoFreeMdl", { 1, h_ObQueryNameString } }, // todo impl IoFreeMdl 
    { "ObReferenceObjectByName", { 1, h_ObQueryNameString } }, // todo impl ObReferenceObjectByName 
    { "KeStackAttachProcess", { 1, h_ObQueryNameString } }, // todo impl KeStackAttachProcess 
    { "KeUnstackDetachProcess", { 1, h_ObQueryNameString } }, // todo impl KeUnstackDetachProcess 
    { "PsGetProcessPeb", { 1, h_PsGetProcessPeb } },
    { "KeInitializeApc", { 1, h_ObQueryNameString } },// todo impl KeInitializeApc 
    { "KeInsertQueueApc", { 1, h_ObQueryNameString } },// todo impl KeInsertQueueApc 
    { "MmUnmapViewOfSection", { 1, h_ObQueryNameString } },// todo impl MmUnmapViewOfSection 
    { "PsSuspendProcess", { 1, h_ObQueryNameString } },// todo impl PsSuspendProcess 
    { "PsResumeProcess", { 1, h_ObQueryNameString } },// todo impl PsResumeProcess 
    { "IoThreadToProcess", { 1, h_ObQueryNameString } },// todo impl IoThreadToProcess 
    { "PsGetContextThread", { 1, h_ObQueryNameString } },// todo impl PsGetContextThread 
    { "MmCopyVirtualMemory", { 1, h_ObQueryNameString } },// todo impl MmCopyVirtualMemory 
    { "MmMapIoSpace", { 1, h_ObQueryNameString } },// todo impl MmMapIoSpace 
    { "MmUnmapIoSpace", { 1, h_ObQueryNameString } },// todo impl MmUnmapIoSpace 
    { "MmGetPhysicalAddress", { 1, h_ObQueryNameString } },// todo impl MmGetPhysicalAddress 
    { "PsGetProcessSessionId", { 1, h_ObQueryNameString } },// todo impl PsGetProcessSessionId 
    { "MmCopyMemory", { 1, h_ObQueryNameString } },// todo impl MmCopyMemory 
};