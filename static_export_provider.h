...
MONITOR uint64_t MmHighestUserAddress = 0x7ffffe;
MONITOR uint64_t MmSectionObjectType = 0;
MONITOR uint64_t MmSystemRangeStart = 0x800000;
MONITOR uint64_t MmUserProbeAddress = 0x7ffffe;
...
MONITOR uint64_t NtBuildNumber = 0;
...
MONITOR uint64_t PsThreadType = 0;
